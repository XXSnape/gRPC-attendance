...
class Attendance(_message.Message):
    ...
    def __init__(
        self,
        status: _Optional[
            _Union[Attendance.AttendanceStatus, str]
        ] = ...,
        decryption: _Optional[str] = ...,
    ) -> None: ...
...
class GroupLesson(_message.Message):
    ...
    id: str
    complete_name: str
    attendances: _containers.RepeatedCompositeFieldContainer[
        StudentAttendance
    ]
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        complete_name: _Optional[str] = ...,
        attendances: _Optional[
            _Iterable[_Union[StudentAttendance, _Mapping]]
        ] = ...,
        can_be_edited_by_prefect: bool = ...,
    ) -> None: ...
...
class TotalAttendance(_message.Message):
    ...
    def __init__(
        self,
        total_students: _Optional[int] = ...,
        present_students: _Optional[int] = ...,
    ) -> None: ...
...
class Schedule(_message.Message):
    ...
    teachers: _containers.RepeatedCompositeFieldContainer[
        _user_pb2.UserFullName
    ]
    can_be_edited_by_prefect: bool
    ...
    def __init__(
        ...
        date: _Optional[str] = ...,
        type_of_lesson: _Optional[str] = ...,
        is_standardized: bool = ...,
        subgroup_number: _Optional[int] = ...,
        lesson: _Optional[_Union[LessonData, _Mapping]] = ...,
        student_data: _Optional[
            _Union[StudentLesson, _Mapping]
        ] = ...,
        time: _Optional[str] = ...,
        audiences: _Optional[
            _Iterable[_Union[Audience, _Mapping]]
        ] = ...,
        teachers: _Optional[
            _Iterable[_Union[_user_pb2.UserFullName, _Mapping]]
        ] = ...,
        can_be_edited_by_prefect: bool = ...,
        group_names: _Optional[_Iterable[str]] = ...,
        total_attendance: _Optional[
            _Union[TotalAttendance, _Mapping]
        ] = ...,
    ) -> None: ...
